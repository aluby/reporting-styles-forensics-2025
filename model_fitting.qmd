...
exID_levels <- levels(factor(busey_data$exID))
busey_Nre_3cat_theta_est <- tibble::tibble(exID = exID_levels, 
                                           theta_med = 0,
                                           theta_error = 0,
                                           theta_Q2.5 = 0,
                                           theta_Q97.5 = 0)
...
exID_levels <- levels(factor(hicklin_data$exID))
hicklin_Nre_3cat_theta_est <- tibble::tibble(exID = exID_levels, 
                                           theta_med = 0,
                                           theta_error = 0,
                                           theta_Q2.5 = 0,
                                           theta_Q97.5 = 0)
...
exID_levels <- levels(factor(ulery_data$exID))
ulery_Nre_3cat_theta_est <- tibble::tibble(exID = exID_levels, 
                                           theta_med = 0,
                                           theta_error = 0,
                                           theta_Q2.5 = 0,
                                           theta_Q97.5 = 0)
